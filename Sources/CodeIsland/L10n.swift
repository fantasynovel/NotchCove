...
final class L10n: ObservableObject {
    ...
    private static let en: [String: String] = [
        ...
        "collapsed_width_scale_desc": "Adjust the collapsed island width (100% matches the physical notch)",
        "notch_layout_mode": "Notch Layout",
        "notch_layout_mode_desc": "Extended keeps status icons beside the notch; Compact stays inside the physical notch",
        "notch_layout_extended": "Extended",
        "notch_layout_compact": "Compact",
    ...
    private static let zh: [String: String] = [
        ...
        "collapsed_width_scale_desc": "调整灵动岛收起宽度（100% 对齐物理刘海）",
        "notch_layout_mode": "灵动岛布局",
        "notch_layout_mode_desc": "延伸模式在刘海两侧显示状态；紧凑模式将内容完全收进物理刘海范围",
        "notch_layout_extended": "延伸",
        "notch_layout_compact": "紧凑",
    ...
    private static let ja: [String: String] = [
        ...
        "collapsed_width_scale_desc": "折りたたみ時のアイランド幅を調整します（100% で物理ノッチと一致）",
        "notch_layout_mode": "ノッチレイアウト",
        "notch_layout_mode_desc": "拡張はノッチの両側にステータスを表示、コンパクトは物理ノッチ内に収めます",
        "notch_layout_extended": "拡張",
        "notch_layout_compact": "コンパクト",
    ...
    private static let ko: [String: String] = [
        ...
        "collapsed_width_scale_desc": "접힌 아일랜드 너비를 조정합니다 (100%는 물리적 노치와 일치)",
        "notch_layout_mode": "노치 레이아웃",
        "notch_layout_mode_desc": "확장은 노치 양옆에 상태를 표시, 컴팩트는 물리 노치 안에 머뭅니다",
        "notch_layout_extended": "확장",
        "notch_layout_compact": "컴팩트",
    ...
    private static let tr: [String: String] = [
        ...
        "collapsed_width_scale_desc": "Daraltılmış ada genişliğini ayarla (100% fiziksel çentikle eşleşir)",
        "notch_layout_mode": "Çentik Düzeni",
        "notch_layout_mode_desc": "Genişletilmiş çentiğin yanında durum gösterir; Kompakt fiziksel çentik içinde kalır",
        "notch_layout_extended": "Genişletilmiş",
        "notch_layout_compact": "Kompakt",
