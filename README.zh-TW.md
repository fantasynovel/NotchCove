...
1. 前往 [Releases](https://github.com/fantasynovel/NotchCove/releases) 頁面
2. 下載 `NotchCove.dmg`
3. 開啟 DMG,將 `NotchCove.app` 拖進「應用程式」資料夾
4. 啟動 NotchCove — 會自動為偵測到的 AI 工具安裝 hook

> **提示:** 首次啟動若 macOS 跳出安全提示,前往 **系統設定 → 隱私權與安全性** 點擊「仍要打開」,或在終端執行:
>
> ```bash
